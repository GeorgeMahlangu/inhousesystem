        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Add Tutor</h3>
                    <div class="row mb-3">
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col">
                                        ...
                                        <div class="card-body">
                                            <form action="register-tutor.php" method="POST">
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Student
                                                                ...
                                                                class="form-control" type="text" id="username"
                                                                placeholder="Student Number" name="student-number">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                ...
                                                                class="form-control" name="campus">
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                ...
                                                                required="" class="form-control" type="email"
                                                                id="first_name" placeholder="someone@xzy.co.za"
                                                                name="email"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                ...
                                                                id="last_name" placeholder="Cellphone Number"
                                                                name="cellnumber"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group"><label
                                                                ...
                                                                class="form-control" type="password" id="passwordVerify"
                                                ...
                                                <div class="form-group"><button name="register"
                                                        class="btn btn-primary btn-sm" type="submit">Register
                                                        Tutor</button></div>
                                            </form>
                                        </div>
                                    </div>
