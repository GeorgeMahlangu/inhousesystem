                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3"
                        ...
                        <form
                            ...
                            <div class="input-group"><input class="bg-light form-control border-0 small" type="text"
                                ...
                                <div class="input-group-append"><button class="btn btn-primary py-0" type="button"
                                        style="background: #023e8a;"><i class="fas fa-search"></i></button></div>
                            </div>
                        </form>
                        <ul class="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link"
                                        aria-expanded="false" data-toggle="dropdown" href="#"><span
                                            class="d-none d-lg-inline mr-2 text-gray-600 small">Moleboheng
                                            Mashilo</span><img class="border rounded-circle img-profile"
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Subject
                                                                    Code</strong><br></label><input class="form-control"
                                                                type="text" id="username" placeholder="Subject Code"
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Subject
                                                                ...
                                                                type="text" id="username" placeholder="Subject Name"
                                                                name="subjectName"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Course
                                                                    Code</strong><br></label><select
                                                                class="form-control">
                                                                <option value="undefined" selected="">Select Course
                                                                </option>
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="first_name"><strong>Subject
                                                                    Head</strong><br></label><input class="form-control"
                                                                type="text" name="staffNumber"
                                                                placeholder="Staff Number"></div>
                                                    </div>
                                                </div>
                                                <div class="form-group"><button class="btn btn-primary btn-sm"
                                                        type="submit">Add Module</button></div>
                                            </form>
                                        </div>
                                    </div>
