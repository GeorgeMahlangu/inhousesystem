...
if (isset($_POST['register'])) {
	...
	try {
		...
		if ($row['numrows1'] > 0) {
			...
			$stmt = $conn->prepare("INSERT INTO `student` (`studentNum`,`initials`, `lastname`, `email`,`contactNr`, `password`, `condition_reAdmission`, `reason`, `subjCode`, `interviewedStatus`, `interviewDate`, `interviewRemarks`, `highSchool`, `Province`, `town` ) VALUES (:studentNum, :initials, :lastname, :email, :contact, :password, :condition, :reason, :subjCode, :interviewed, NULL, NULL, NULL, NULL, NULL)");
