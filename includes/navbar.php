<header class="main-header">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="index.php"
                style="background: url(&quot;assets/img/1200px-Tshwane_University_of_Technology_logo.svg (2).png&quot;) no-repeat;height: 62px;"></a><button
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link active js-scroll-trigger" href="index.php"
                            style="/*border-color: rgb(240, 95, 64);*/border-top-color: rgb(240,;border-right-color: 95,;border-bottom-color: 64);border-left-color: 95,;color: var(--blue);">HOMe</a>
                    </li>
