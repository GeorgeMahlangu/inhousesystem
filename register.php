...
<head>
    ...
    <link rel="stylesheet" href="admin/assets/fonts/material-icons.min.css">
            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image" style="background: url(&quot;admin/assets/img/Login%20image.jpg&quot;) no-repeat;background-size: cover;"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="register_student.php" method="POST">
                                ...
                                <div class="form-check"><input class="form-check-input" name="module" value="CGS10BT" type="checkbox" id="formCheck-1"><label class="form-check-label" for="formCheck-1">CGS10BT</label></div>
                                <div class="form-check"><input class="form-check-input" name="module" value="TPG111T" type="checkbox" id="formCheck-2"><label class="form-check-label" for="formCheck-1">TPG111T</label></div>
                                <div class="form-check"><input class="form-check-input" name="module" value="TPG201T" type="checkbox" id="formCheck-1"><label class="form-check-label"  for="formCheck-1">TPG201T</label></div>
                                <div class="form-check"><input class="form-check-input" name="module" value="IEE20BT" type="checkbox" id="formCheck-9"><label class="form-check-label" for="formCheck-1">IEE20BT</label></div>
                                <div class="form-check"><input class="form-check-input"  name="module" value="DSO23BT" type="checkbox" id="formCheck-9"><label class="form-check-label" for="formCheck-1">DSO23BT</label></div>
                                <div class="form-group"><textarea class="form-control" placeholder="Reason for Intervention (Reason for not performing well)" style="margin-top: 15px;border-radius: 160px;padding-left: 20px;" name="reason"></textarea><textarea class="form-control" placeholder="Condition for upliftment" style="margin-top: 15px;border-radius: 160px;padding-left: 20px;" name="upliftment-condition"></textarea><input class="form-control" type="number" placeholder="Total Number of Modules registered this year." style="margin-top: 15px;border-radius: 160px;" min="0" max="10" name="no_modules"></div>
